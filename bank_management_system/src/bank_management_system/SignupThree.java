...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        // Logo
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("bank_management_system/logo.jpg"));
        ...
        r4.setBounds(350,220,300,30); add(r4);
        ...
        c7.setBounds(100,650,600,30); add(c7);
    ...
    public static void main(String[] args){
        new SignupThree("1001");   // Test form number
    }
}